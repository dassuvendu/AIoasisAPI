    ...
    <div className="create_character_wrap px-3 md:px-0 ml-0 md:ml-4">
      ...
      <div className="py-0 lg:py-0">
        <div className="container mx-auto my-0">
          ...
          <div className="terms_list_item pb-4">
            <ul className="pl-5 text-[#acacac]">
              ...
              <li>
                ...
                "Our" in this Agreement) refers to LustyGPT LTD ( the website
                property AI oasis.com).
              </li>
              <li>
              ...
              <li>Country refers to: Bishui Plain, Liyue</li>
              <li>
              ...
              <li>Website refers to AI oasis, accessible from AI oasis.com</li>
              <li>
          ...
          <h3 className="text-lg text-gray-300 font-medium pb-3">
            Personal Data
          </h3>
          <p className="pb-4 text-[#acacac]">
          ...
          <h3 className="text-lg text-gray-300 font-medium pb-3">Usage Data</h3>
          <p className="pb-4 text-[#acacac]">
            Usage Data is collected automatically when using the Service.
          </p>
          <p className="pb-4 text-[#acacac]">
            Usage Data may include information such as Your Device's Internet
            Protocol address (e.g. IP address), br/owser type, br/owser version,
          ...
          <div className="terms_list_item pb-4">
            <ul className="pl-5 text-[#acacac]">
              ...
              <li>
                ...
                provide You with a more personal experience and to avoid having
          ...
          <div className="terms_list_item pb-4">
            <ul className="pl-5 text-[#acacac]">
              ...
              <li>
                ...
                or conduct a merger, divestiture, restructuring, reorganisation,
              ...
              <li>
                ...
                evaluating and improve our Service, products, services,
          ...
          <p className="pb-4 text-[#acacac]">By email: support@aioasis.com</p>
        </div>
      </div>
