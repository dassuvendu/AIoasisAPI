    ...
    <div className="create_character_wrap px-3 md:px-0 ml-0 md:ml-4">
      ...
      <div className="py-0 lg:py-0">
        <div className="container mx-auto my-0">
          <h1 className="text-2xl font-medium pb-3 text-[#00a3ff]">
            Terms of Use
          </h1>
          <p className="pb-4 text-[#acacac]">
            The AI oasis website located at AI oasis.com is a copyrighted work
            belonging to LustyGPT LTD. Certain features of the Site may be
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            OF THE PROVISIONS OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE
            SITE.
          </p>
          <p className="pb-4 text-[#acacac]">
          ...
          <h2 className="text-2xl font-medium pb-3 text-[#00a3ff]">
            Access to the Site
          </h2>
          <p className="pb-4 text-[#acacac]">
          ...
          <p className="pb-4 text-[#acacac]">
            We reserve the right to change, suspend, or cease the Site with or
            without notice to you. You approved that We will not be held liable
            to you or any third party for any change, interruption, or
            termination of the Site or any part.
          </p>
          <p className="pb-4 text-[#acacac]">
            No Support or Maintenance. You agree that we will have no obligation
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            by We or We’s suppliers. Note that these Terms and access to the
            Site do not give you any rights, title or interest in or to any
            intellectual property rights, except for the limited access rights
            expressed in Section 2.1. We and its suppliers reserve all rights
          ...
          <p className="pb-4 text-[#acacac]">
            Welcome to our subscription service (hereinafter referred to as the
            "Service"). This service is provided by AI oasis (hereinafter
            referred to as "we" or "the Company"). By using or subscribing to
            our service, you agree to comply with these Subscription Terms
            (hereinafter referred to as the "Terms").
          </p>
          <p className="pb-4 text-[#acacac]">
            We will provide you with subscription-based services, including
            exclusive user quotas. The specific service offerings and fees may
            change at any time and will be updated through notifications via
            email or on our website.
          </p>
          <p className="pb-4 text-[#acacac]">
            Subscription fees, payment methods, and payment cycles are detailed
            on the pricing page. Accounts with overdue payments will have their
            paid services temporarily suspended. All subscription fees are
            non-refundable unless required by law or at our sole discretion. You
            can cancel your subscription at any time. Upon cancellation, we will
            continue to provide services until the end of the current
            subscription period, but no refunds will be issued for fees already
            paid.
          </p>
          <p className="pb-4 text-[#acacac]">
            We also reserve the right to unilaterally terminate or suspend your
            service in the following circumstances:
          </p>
          <div className="terms_list_item pb-4">
            <ul className="pl-5 text-[#acacac]">
              <li>Violation of these Terms</li>
              <li>Non-payment of subscription fees</li>
            </ul>
          </div>
          <p className="pb-4 text-[#acacac]">
            We will make every effort to provide high-quality services, but we
            do not make any express or implied warranties regarding the
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            with the use of your User Content. You hereby certify that your User
            ...
            provided, sponsored or endorsed by We. Because you alone are
            responsible for your User Content, you may expose yourself to
            liability. We are not obliged to back up any User Content that you
            post; also, your User Content may be deleted at any time without
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            defamatory, false, intentionally misleading, trade libellous,
            pornographic involving minors, patently offensive, promotes racism,
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            We with any feedback or suggestions regarding the Site, you hereby
            assign to We all rights in such Feedback and agree that We shall
            have the right to use and fully exploit such Feedback and related
            information in any manner it believes appropriate. We will treat any
            Feedback you provide to Us as non-confidential and non-proprietary.
            You agree to indemnify and hold We and its officers, employees, and
            ...
            use of the Site, (b) your violation of these Terms, (c) your
            violation of applicable laws or regulations or (d) your User
            Content. We reserve the right to assume the exclusive defence and
            ...
            We. We will use reasonable efforts to notify you of any such claim,
          ...
          <p className="pb-4 text-[#acacac]">
            Other Users. Each Site user is solely responsible for any of its own
            ...
            You hereby release and forever discharge the Us and our officers,
            employees, agents, successors, and assigns from, and hereby waive
            and relinquish, every past, present and future dispute, claim,
            controversy, demand, right, obligation, liability, action and cause
            of action of every kind and nature, that has arisen or arises
            ...
            or her favour at the time of executing the release, which if known
            by him or she must have materially affected his or her settlement
            with the debtor."
          </p>
          <p className="pb-4 text-[#acacac]">
          ...
          <p className="pb-4 text-[#acacac]">
            The site is provided on an "as-is" and "as-available" basis, and We
            and our suppliers expressly disclaim any warranties and conditions
            of any kind, whether express, implied, or statutory, including all
            warranties or conditions of merchantability, fitness for a
            particular purpose, title, quiet enjoyment, accuracy, or
            non-infringement. We and our suppliers do not guarantee that the
            ...
            legal, or safe. If applicable law requires any warranties concerning
            the site, all such warranties are limited in duration to ninety (90)
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            incapability to use the site even if We has been advised of the
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            limitation or exclusion may not apply to you. Term and Termination.
            ...
            involve the deletion of your User Content associated with your
          ...
          <p className="pb-4 text-[#acacac]">
            Disclaimer. THE SERVICES ARE PROVIDED “AS IS.” EXCEPT TO THE EXTENT
            ...
            TO THE SERVICES, AND DISCLAIM ALL WARRANTIES INCLUDING BUT NOT
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            our Site do the same. In connection with our Site, we have adopted
            and implemented a policy respecting copyright law that provides for
            the removal of any infringing materials and for the termination of
          ...
          <h2 className="text-2xl font-medium pb-3 text-[#00a3ff]">General</h2>
          <p className="pb-4 text-[#acacac]">
            ...
            Arbitration Agreement carefully. It is part of your contract with We
            and affects your rights. It contains procedures for MANDATORY
            BINDING ARBITRATION AND A className ACTION WAIVER. Applicability of
            Arbitration Agreement. All claims and disputes in connection with
            the Terms or the use of any product or service provided by the We
            ...
            Agreement applies to you and the We, and to any subsidiaries,
            affiliates, agents, employees, predecessors in interest, successors,
            and assigns, as well as all authorized or unauthorized users or
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            the claim or dispute and the requested relief. A Notice to the We
            should be sent to our contact email. After the Notice is received,
            you and the We may attempt to resolve the claim or dispute
            informally. If you and the We do not resolve the claim or dispute
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            than the last settlement offer that the We made to you prior to the
            initiation of arbitration, the We will pay you the greater of the
            award or $2,500.00. Each party shall bear its own costs and
            disbursements arising out of the arbitration and shall pay an equal
            share of the fees and costs of the ADR Provider. Additional Rules
            for Non-Appearance Based Arbitration. If non-appearance-based
            arbitration is elected, the arbitration shall be conducted by
            telephone, online and/or based solely on written submissions; the
            specific manner shall be chosen by the party initiating the
            arbitration. The arbitration shall not involve any personal
            appearance by the parties or witnesses unless otherwise agreed by
            the parties.
          </p>
          <p className="pb-4 text-[#acacac]">
            Time Limits. If you or the We pursue arbitration, the arbitration
            action must be initiated and/or demanded within the statute of
            limitations and within any deadline imposed under the AAA Rules for
            the pertinent claim.
          </p>
          <p className="pb-4 text-[#acacac]">
            Authority of Arbitrator. If arbitration is initiated, the arbitrator
            will decide the rights and liabilities of you and the We, and the
            ...
            award of the arbitrator is final and binding upon you and the We.
          </p>
          <p className="pb-4 text-[#acacac]">
            ...
            should arise between you and the We in any state or federal court in
            a suit to vacate or enforce an arbitration award or otherwise, YOU
            AND THE We WAIVE ALL RIGHTS TO A JURY TRIAL, instead electing that
            the dispute be resolved by a judge.
          </p>
          <p className="pb-4 text-[#acacac]">
            Waiver of className or Consolidated Actions. All claims and disputes
            within the scope of this arbitration agreement must be arbitrated or
            litigated on an individual basis and not on a className basis, and
            ...
            or user. Confidentiality. All aspects of the arbitration proceeding
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            Agreement shall continue in full force and effect. Right to Waive.
            ...
            portion of this Arbitration Agreement. Survival of Agreement. This
            Arbitration Agreement will survive the termination of your
            relationship with We.
          </p>
          <p className="pb-4 text-[#acacac]">
            Small Claims Court. Nonetheless the foregoing, either you or the We
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            Netherlands County, California, for such purposes. The Site may be
            subject to U.S. export control laws and may be subject to export or
            import regulations in other countries. You agree not to export,
            re-export, or transfer, directly or indirectly, any U.S. technical
            data acquired from We, or any products utilizing such data, in
            violation of the United States export laws or regulations.
          </p>
          <p className="pb-4 text-[#acacac]">
            Electronic Communications. The communications between you and We use
            electronic means, whether you use the Site or send us emails, or
            whether We post notices on the Site or communicate with you via
            email. For contractual purposes, you (a) consent to receive
            communications from We in an electronic form; and (b) agree that all
            ...
            legal obligation that such communications would satisfy if it were
          ...
          <p className="pb-4 text-[#acacac]">
            ...
            relationship to We is that of an independent contractor, and neither
            ...
            and void. We may freely assign these Terms. The terms and conditions
            set forth in these Terms shall be binding upon assignees.
          </p>
          <p className="pb-4 text-[#acacac]">
            Your Privacy. Please read our Privacy Policy. Copyright/Trademark
          ...
          <p className="pb-4 text-[#acacac]">Email: Support@aioasis.com</p>
        </div>
      </div>
